<!-- jQuery 2.2.3 -->
<script src="<?php echo base_url() . 'assets/plugins/jquery/dist/jquery.min.js' ?>">
</script>
<!-- Bootstrap 3.3.6 -->
...
<!-- FastClick -->
<script src="<?php echo base_url() . 'assets/plugins/fastclick/fastclick.js' ?>">
</script>
<!-- AdminLTE App -->
<script src="<?php echo base_url() . 'assets/dist/js/app.min.js' ?>">
</script>
